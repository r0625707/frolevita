...
<html>
    <jsp:include page="head.jsp">
        <jsp:param name="title" value="Chiro Haacht | Info"/>
    </jsp:include>
    <body>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="contact">
                    ...
                    <ul>
                        ...
                        <li>
                            <h3>Hoofdleiding</h3>
                            <ul>
                                <li>Hanne Huberland: <a href="mailto:"></a>, +32</li>
                                <li>Shari Schreine: <a href="mailto:"></a>, +32</li>
                            </ul>
                        </li>
                        <li>
                            <h3>Volwassen begeleiders</h3>
                            <ul>
                                <li>Sanne Antonus: <a href="mailto:"></a>, +32</li>
                                <li>Stijn Jacobs: <a href="mailto:"></a>, +32</li>
                            </ul>
                        </li>
                        <li>
                            <h3>Adres</h3>
